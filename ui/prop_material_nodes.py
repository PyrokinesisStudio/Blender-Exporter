    ...
    def get_from_context(cls, context):
        ...
        if ob and ob.type not in {'LAMP', 'CAMERA'}:
            ...
            if mat != None:
                ...
                if nt_name != '':
                    return bpy.data.node_groups[nt_name], ob, mat
...
class TheBountyTranslucentShaderNode(Node, TheBountyMaterialNode):
    ...
    def init(self, context):
        ...
        self.inputs.new('absorption_color', 'Absorption')

        self.inputs.new('scatter_color', 'Scattering')
...
class TheBountyBlendShaderNode(Node, TheBountyMaterialNode):
    ...
    def draw_buttons(self, context, layout):
        #
        layout.prop_search(self, 'BlendOne', bpy.data, 'materials', text='')

        layout.prop(self, "blend_amount", text="", slider=True)

        layout.prop_search(self, 'BlendTwo', bpy.data, 'materials', text='')
